...
router.put('/read-all', auth_1.authenticate, notificationController.markAllAsRead);
...
router.get('/preferences', auth_1.authenticate, notificationController.getNotificationPreferences);
router.put('/preferences', auth_1.authenticate, notificationController.updateNotificationPreferences);
